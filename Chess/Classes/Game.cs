...
namespace Chess.Classes
{
    public class Game
    {
        ...
        public Game(Button[,] Buttons, string filePath, TreeView tree, bool Load, ListView listView)
        {
            ...
            {
                ChessTree.Load();
                Pieces = ChessTree.GetCurrentNode().GetPieces(ChessTree.GetCurrentNode().Board).ToList();
                TakenPiece = ChessTree.GetEatenPieece(ChessTree.GetCurrentNode());
            }
            

            Setups.SetupBoard(Pieces , Buttons);
            Setups.SetupTree(tree, ChessTree);
            Setups.SetupTakenPiece(TakenPiece,listView);
        }
